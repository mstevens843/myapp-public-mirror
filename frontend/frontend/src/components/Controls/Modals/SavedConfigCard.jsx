...
const STRAT_EXTRAS = {
  ...
  scalper: ["entryThreshold", "volumeThreshold", "priceWindow", "volumeWindow"],
  ...
  chadMode: ["useMultiTargets", "outputMint", "targetTokens", "minVolumeRequired", "priorityFeeLamports", "slippageMaxPct", "feeEscalationLamports", "panicDumpPct"],
