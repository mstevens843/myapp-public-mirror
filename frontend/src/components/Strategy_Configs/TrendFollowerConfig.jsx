// src/components/strategies/TrendFollowerConfig.jsx
// TrendFollowerConfig.jsx — hoisted tabs + stable controlled inputs (no draft state, no logging imports)
import React, {
  useMemo,
  useState,
  useCallback,
...
const TrendFollowerConfig = ({
  ...
  const isRawInputMode =
    ...
    (localStorage.BREAKOUT_RAW_INPUT_MODE === "1" ||
      localStorage.TRENDFOLLOWER_RAW_INPUT_MODE === "1");
  ...
  const clearActiveField = useCallback(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      window.__TRENDFOLLOWER_ACTIVE_FIELD = null;
    }
  }, []);
  ...
  const handleFocusCapture = useCallback((e) => {
    ...
    if (typeof window !== "undefined") {
      ...
      window.__TRENDFOLLOWER_ACTIVE_FIELD = name;
    }
  }, []);
