...
const STRAT_EXTRAS = {
  ...
  dipBuyer: [
    "dipThreshold","recoveryWindow","volumeWindow","volumeThreshold",
  ],
  breakout: [
    "breakoutThreshold","volumeThreshold","volumeWindow","priceWindow",
  ],
  trendFollower: [
    "entryThreshold","volumeThreshold","trendWindow",
    "priceWindow","volumeWindow",
  ],
  delayedSniper: [
    "delayMs","entryThreshold","volumeThreshold","priceWindow","volumeWindow",
    "minTokenAgeMinutes","maxTokenAgeMinutes",
  ],
  chadMode: [
    "minVolumeRequired","slippageMaxPct","feeEscalationLamports",
    "panicDumpPct","priorityFeeLamports",
  ],
  rotationBot: [
    "rotationInterval","priceChangeWindow","minMomentum","positionSize",
    "cooldown","maxRotations","maxTradesPerCycle",
  ],
  rebalancer: [
    "maxRebalances","rebalanceThreshold","rebalanceInterval","targetAllocations",
  ],
  paperTrader: [
    "maxSpendPerToken","entryThreshold","volumeThreshold",
    "priceWindow","volumeWindow",
  ],
  stealthBot: [
    "tokenMint","positionSize",
  ],
  scheduleLauncher: [
    "startTime","interval","maxTrades","limitPrices",
  ],
};
